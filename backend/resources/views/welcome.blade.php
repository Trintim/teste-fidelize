                ...
                <div class="p-6">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Além da documentação do Laravel, o google sempre será o seu melhor amigo para buscar
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="ml-4 text-lg leading-7 font-semibold">
                            <a href="/api/company"
                               class="underline text-gray-900 dark:text-white">Endpoint inicial</a>
                        </div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Endpoint inicial criado dentro do controller de empresas para iniciar :)
                        </div>
                    </div>
                </div>
            </div>
